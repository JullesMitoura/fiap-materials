# Projeto 01 - Aplicacao de Redes Neurais
...
A entrega consiste em um **Jupyter Notebook** (`.ipynb`) executavel e um **relatorio em PDF** descrevendo as decisoes e resultados.
...
**O notebook e o relatorio devem conter:**
...
O relatorio deve ter entre **3 e 5 paginas** e cobrir obrigatoriamente:
...
- Material das Aulas 3, 4 e 5 - Disciplina Redes Neurais e Aplicacoes (FIAP)
